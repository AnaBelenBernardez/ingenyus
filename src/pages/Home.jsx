    ...
    return (
        <main className='noise homePage'>
            <h1 className='homeTitle'>
                ...
                <span id='homeTitle2'> {t('translation.title2')}</span>
                <span id='homeTitle3'> {t('translation.title3')}</span>
            </h1>
            <img className='homeAddons' src='./logos/HAB_icon.svg' alt='' />
            <img className='homeAddons' src='./logos/in_asterisco.svg' alt='' />
